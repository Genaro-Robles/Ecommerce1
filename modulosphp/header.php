    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="index">GreedStore</a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown" id="drop-menu1">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown" id="drop1">
                                ...
                                <li><a class="dropdown-item" href="index?cat=1">Tarjetas de video</a></li>
                                <li><a class="dropdown-item" href="index?cat=2">Procesadores</a></li>
                                <li><a class="dropdown-item" href="index?cat=3">Disco Duro</a></li>
                                <li><a class="dropdown-item" href="index?cat=4">Fuente de Poder</a></li>
                                <li><a class="dropdown-item" href="index?cat=5">Memoria ram</a></li>
                                <li><a class="dropdown-item" href="index?cat=6">Placa Base</a></li>
                            </ul>   
                        </li>
